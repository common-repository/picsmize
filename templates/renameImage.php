...
if(!$isAutoRename) $isAutoRename = 0;
$renameSettings = array("file_rename_mode"=>"","file_rename_rules"=>"","file_settings_setup"=>"");
$currentPlan = array();
$isFreePlan = true;
		...
		<div class="Polaris-Layout">
				...
				<div class="Polaris-Layout__AnnotationWrapper">
					<div class="Polaris-Layout__Annotation">
						<div class="Polaris-TextContainer">
							...
							<div class="Polaris-Layout__AnnotationDescription">
								<p>The new name of the file will be based on the given information.</p>
							</div>
						</div>
					</div>
												...
												<div style="color: var(--p-action-primary);">
													<button front-title='<?php echo esc_attr($value['type'] == 'custom' ? $value['value'] : $value['title']); ?>' title='<?php echo esc_attr($value['type'] == 'custom' ? $value['value'] : picsmizeLang(str_replace(' ', '_', $value['title']))) ?>' value='<?php echo esc_attr($value['value']); ?>' class="Polaris-Button Polaris-Button--outline Polaris-Button--monochrome Added-Property-Button <?php echo esc_attr($value['type'] == 'custom' ? 'customTag' : '');?>" type="button">
														...
														<span class="Polaris-Button__Content">
															...
															<?php }else{ ?>
																<span class="Polaris-Button__Text"><?php echo esc_attr($value['value']); ?></span>
															<?php } ?>
														</span>
													</button>
												</div>
			...
			<div class="Polaris-Layout__AnnotatedSection">
				<div class="Polaris-Layout__AnnotationWrapper">
					<div class="Polaris-Layout__Annotation">
						<div class="Polaris-TextContainer">
							<h2 class="Polaris-Heading"><?php _e('Auto file rename Mode','Picsmize') ?></h2>
							<div class="Polaris-Layout__AnnotationDescription">
								<p>This option will check for new image and will rename file name automatically as per settings.</p>
							</div>
				      	</div>
				  	</div>
					  				...
					  				<label class="Polaris-Choice" for="automatic">
					  					<span class="Polaris-Choice__Control">
					  						<span class="Polaris-Checkbox">
					  							<input name="auto_mode" id="automatic"  type="checkbox" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false" value="1" <?php echo esc_attr($isAutoRename == '1' ? 'checked' : '');?>>
					  							...
					  							<span class="Polaris-Checkbox__Icon">
					  								<span class="Polaris-Icon">
					  									...
					  									<span class="Polaris-Choice__Label">Change file name for all new images automatically.</span></label>
			...
			<div class="Polaris-Layout__AnnotatedSection">
				<div class="Polaris-Layout__AnnotationWrapper">
					<div class="Polaris-Layout__Annotation">
						<div class="Polaris-TextContainer">
							<h2 class="Polaris-Heading"><?php _e('Preview for image new name','Picsmize') ?></h2>
						</div>
					</div>
					<div class="Polaris-Layout__AnnotationContent">
						<div class="Polaris-Card" style="position: relative;">
							...
							<div class="Polaris-Card__Section">
								<div class="Polaris-Card__SectionHeader">
									<h3 aria-label="Summary" class="Polaris-Subheading">NEW NAME OF IMAGE WILL LOOK LIKE THIS :</h3>
								</div>
								<p id="New-Image-Name" class=""></p>
							</div>
							<div class="Polaris-Card__Section">
								<div class="Polaris-Card__SectionHeader">
									<h3 aria-label="Summary" class="Polaris-Subheading">CURRENT NAME OF THE IMAGE :</h3>
								</div>
	...
	<div class="Polaris-PageActions">
		<div class="Polaris-Stack Polaris-Stack--spacingTight Polaris-Stack--distributionTrailing">
			...
			<div class="Polaris-Stack__Item">
				<button class="Polaris-Button Polaris-Button--primary" type="button" id="settings-save">
					<span class="Polaris-Button__Content">
						...
						<div class="Polaris-ButtonGroup">
							<div class="Polaris-ButtonGroup__Item">
								<button id="add-custom" class="Polaris-Button Polaris-Button--primary" type="button">
									<span class="Polaris-Button__Content">
										<span class="Polaris-Button__Text"><?php echo _e('Add','Picsmize') ?></span>
									</span>
								</button>
							</div>
						</div>
